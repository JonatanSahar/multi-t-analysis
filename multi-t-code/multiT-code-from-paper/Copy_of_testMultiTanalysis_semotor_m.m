...
params.dataLocation=fullfile(params.dataDir,num2str(subject),'/derive/pc_data/forMultiT',['pc_TR' num2str(TRafterEV)]);
params.outputDir=fullfile(params.dataDir,num2str(subject) ,'/derive',['multiTmaps_pc_TR' num2str(TRafterEV) '_3.4.20']);
