function computeFFXresults_svm(subsToExtract,fold,ffxResFold,numMaps,cond)
cnt = 1;
...
save(fullfile(ffxResFold,fnTosave),...
    'avgAnsMat','stlzerPermsAnsMat','fnTosave','subsToExtract', '-v7.3');
